...
class AStarPlannerConfig : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:roborts_global_planner.AStarPlannerConfig) */ {
 public:
  ...
  bool has_beziercruve_pointsize() const;
  void clear_beziercruve_pointsize();
  static const int kBeziercruvePointsizeFieldNumber = 2;
  ::google::protobuf::uint32 beziercruve_pointsize() const;
  void set_beziercruve_pointsize(::google::protobuf::uint32 value);

  // optional float heuristic_factor = 3 [default = 1];
  bool has_heuristic_factor() const;
  void clear_heuristic_factor();
  static const int kHeuristicFactorFieldNumber = 3;
  ...
  static const int kGoalSearchToleranceFieldNumber = 4;
 ...
 private:
  ...
  inline void set_has_beziercruve_pointsize();
  inline void clear_has_beziercruve_pointsize();
  ...
  ::google::protobuf::uint32 beziercruve_pointsize_;
...
// optional uint32 beziercruve_pointsize = 2 [default = 3];
inline bool AStarPlannerConfig::has_beziercruve_pointsize() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void AStarPlannerConfig::set_has_beziercruve_pointsize() {
  _has_bits_[0] |= 0x00000002u;
}
inline void AStarPlannerConfig::clear_has_beziercruve_pointsize() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void AStarPlannerConfig::clear_beziercruve_pointsize() {
  beziercruve_pointsize_ = 3u;
  clear_has_beziercruve_pointsize();
}
inline ::google::protobuf::uint32 AStarPlannerConfig::beziercruve_pointsize() const {
...
inline void AStarPlannerConfig::set_beziercruve_pointsize(::google::protobuf::uint32 value) {
