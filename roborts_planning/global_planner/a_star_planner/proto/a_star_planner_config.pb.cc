...
void protobuf_AssignDesc_a_5fstar_5fplanner_5fconfig_2eproto() {
  ...
  static const int AStarPlannerConfig_offsets_[4] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(AStarPlannerConfig, beziercruve_pointsize_),
...
void protobuf_AddDesc_a_5fstar_5fplanner_5fconfig_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "lobal_planner\"\230\001\n\022AStarPlannerConfig\022\036\n\021"
    "inaccessible_cost\030\001 \001(\r:\003253\022 \n\025beziercr"
    "uve_pointsize\030\002 \001(\r:\0013\022\033\n\020heuristic_fact"
    "or\030\003 \001(\002:\0011\022#\n\025goal_search_tolerance\030\004 \001"
    "(\002:\0040.25", 208);
...
const int AStarPlannerConfig::kBeziercruvePointsizeFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        ...
        if (input->ExpectTag(16)) goto parse_beziercruve_pointsize;
        break;
      }

      // optional uint32 beziercruve_pointsize = 2 [default = 3];
      case 2: {
        if (tag == 16) {
         parse_beziercruve_pointsize:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   ::google::protobuf::uint32, ::google::protobuf::internal::WireFormatLite::TYPE_UINT32>(
                 input, &beziercruve_pointsize_)));
          set_has_beziercruve_pointsize();
        } else {
          goto handle_unusual;
        }
        if (input->ExpectTag(29)) goto parse_heuristic_factor;
        break;
      }

      // optional float heuristic_factor = 3 [default = 1];
      case 3: {
        if (tag == 29) {
        ...
        if (input->ExpectTag(37)) goto parse_goal_search_tolerance;
        break;
      }

      // optional float goal_search_tolerance = 4 [default = 0.25];
      case 4: {
        if (tag == 37) {
...
void AStarPlannerConfig::SerializeWithCachedSizes(
  ...
  // optional uint32 beziercruve_pointsize = 2 [default = 3];
  if (has_beziercruve_pointsize()) {
    ::google::protobuf::internal::WireFormatLite::WriteUInt32(2, this->beziercruve_pointsize(), output);
  }

  // optional float heuristic_factor = 3 [default = 1];
  if (has_heuristic_factor()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(3, this->heuristic_factor(), output);
  }

  // optional float goal_search_tolerance = 4 [default = 0.25];
  if (has_goal_search_tolerance()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(4, this->goal_search_tolerance(), output);
  }
...
::google::protobuf::uint8* AStarPlannerConfig::InternalSerializeWithCachedSizesToArray(
  ...
  // optional uint32 beziercruve_pointsize = 2 [default = 3];
  if (has_beziercruve_pointsize()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteUInt32ToArray(2, this->beziercruve_pointsize(), target);
  }

  // optional float heuristic_factor = 3 [default = 1];
  if (has_heuristic_factor()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(3, this->heuristic_factor(), target);
  }

  // optional float goal_search_tolerance = 4 [default = 0.25];
  if (has_goal_search_tolerance()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(4, this->goal_search_tolerance(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:roborts_global_planner.AStarPlannerConfig)
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_beziercruve_pointsize()) {
      set_beziercruve_pointsize(from.beziercruve_pointsize());
    }
...
void AStarPlannerConfig::InternalSwap(AStarPlannerConfig* other) {
  ...
  std::swap(beziercruve_pointsize_, other->beziercruve_pointsize_);
...
// optional uint32 beziercruve_pointsize = 2 [default = 3];
bool AStarPlannerConfig::has_beziercruve_pointsize() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
void AStarPlannerConfig::set_has_beziercruve_pointsize() {
  _has_bits_[0] |= 0x00000002u;
}
void AStarPlannerConfig::clear_has_beziercruve_pointsize() {
  _has_bits_[0] &= ~0x00000002u;
}
void AStarPlannerConfig::clear_beziercruve_pointsize() {
  beziercruve_pointsize_ = 3u;
  clear_has_beziercruve_pointsize();
}
 ::google::protobuf::uint32 AStarPlannerConfig::beziercruve_pointsize() const {
  // @@protoc_insertion_point(field_get:roborts_global_planner.AStarPlannerConfig.beziercruve_pointsize)
  return beziercruve_pointsize_;
}
 void AStarPlannerConfig::set_beziercruve_pointsize(::google::protobuf::uint32 value) {
  set_has_beziercruve_pointsize();
  beziercruve_pointsize_ = value;
  // @@protoc_insertion_point(field_set:roborts_global_planner.AStarPlannerConfig.beziercruve_pointsize)
}
